...
import deploy.encoder_pb2 as encoder__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in encoder_pb2_grpc.py depends on'
...
class EncoderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EncodeAndDecode = channel.unary_unary(
                '/encoder.Encoder/EncodeAndDecode',
...
def add_EncoderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EncodeAndDecode': grpc.unary_unary_rpc_method_handler(
                    servicer.EncodeAndDecode,
...
class Encoder(object):
    ...
    def EncodeAndDecode(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/encoder.Encoder/EncodeAndDecode',
            encoder__pb2.DecodeRequest.SerializeToString,
            encoder__pb2.DecodeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
